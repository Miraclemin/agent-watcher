---
name: claude-watch
description: Bridge your Claude Code session to the Agent Watcher app on Apple Watch
author: shobhit
version: 0.1.0
---
...
to the Agent Watcher iOS/watchOS app.
...
Enter the pairing code in the Agent Watcher iPhone app.
